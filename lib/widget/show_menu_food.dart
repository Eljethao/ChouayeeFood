                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        // print('ສັ່ງຊື້ ${foodModels[index].nameFood} ຈຳນວນ = $amount');
    ...
    if (object.length == 0) {
      ...
      if (idShop == idShopSQLite) {
        ...
        normalDialog(context,
            'ກະຕ່າມີລາຍການອາຫານຂອງຮ້ານ ${object[0].nameShop} ຢູ່ ກະລຸນາຊື້ຈາກຮ້ານນີ້ໃຫ້ສິ້ນສຸດກ່ອນ');
      }
    }
  }
